      ...
      <br></br>
        ...
        <div className="about-container"></div>
          ...
          <div><img src={dog2}/></div>
              <div className="about-us-bio">Lucky had a rough start when he came to us with severe mange and starving. would you just look at that smile now?! </div>
          </div>
          
          <div className="about-us-pic">
              <div><img src={dog3}/></div>
              <div>Brian was found roaming the country roads, now he gets to ride in style and never worry about puppies he can't provide for cuz he has no wallet.</div>
          </div>
          <div className="about-us-pic">
              <div><img src={dog1}/></div>
              <div className="about-us-bio">Suzie came to us when a breeder surrendered her due to her inability to breed; now, shes treated like the queen she truly is. </div>
          </div>
     </div>
    </>
  )
